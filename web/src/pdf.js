...
function stampProductBranding(doc) {
  ...
  for (let page = 1; page <= pages; page++) {
    ...
    // El dominio va a la derecha de la marca, en la misma línea de base. La posición se calcula
    // midiendo el ancho real del nombre en vez de estimarla: así no se solapan si cambia el cuerpo.
...
// Credencial de acceso: una sola carilla, formato CR80 vertical (54 x 85,6 mm). Sigue la
// disposición de la pantalla de verificación que abre el QR: banda de color con el título, foto
